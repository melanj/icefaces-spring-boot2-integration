...
@Named(DataTableLiveScrolling.BEAN_NAME)
@CustomScoped(value = "#{window}")
public class DataTableLiveScrolling implements Serializable 
{
    public static final String BEAN_NAME = "dataTableLiveScrolling";
