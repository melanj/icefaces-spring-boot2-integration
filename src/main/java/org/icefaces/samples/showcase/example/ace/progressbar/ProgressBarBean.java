...
@Named(ProgressBarBean.BEAN_NAME)
@CustomScoped(value = "#{window}")
public class ProgressBarBean implements Serializable {
    public static final String BEAN_NAME = "progressBarBean";
	public String getBeanName() { return BEAN_NAME; }
    
    private ArrayList<ImageInfo> imagesOfCars;
    private Integer progressValue;
    private ImageInfo currentImage;
    private int currentIndex;
    private String message;
    private ImageInfo arrowForwardImage;
    private ImageInfo arrowBackwardImage;
    ...
    public ArrayList<ImageInfo> getImagesOfCars() { return imagesOfCars; }
    ...
    public ImageInfo getCurrentImage() { return currentImage; }
