...
@Named(ScheduleEventEditingBean.BEAN_NAME)
@CustomScoped(value = "#{window}")
public class ScheduleEventEditingBean implements Serializable {
    public static final String BEAN_NAME = "scheduleEventEditingBean";
	public String getBeanName() { return BEAN_NAME; }
    
    private List<ScheduleEvent> events;

	public ScheduleEventEditingBean() {
