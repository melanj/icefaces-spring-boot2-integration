	...
	public static List<CategoryGroup> generate() {
		...
		toReturn.add(new CategoryGroup(msgs("menu.ace.group.list.title"),
				new ComponentGroup("ace:list", "List", "list.html",
						...
						new Demo(msgs("menu.ace.list.subMenu.sorting"), msgs("example.ace.list.sorting.description"),
								 "list", "listSorting.xhtml", "ListSortingBean.java"),
						new Demo(msgs("menu.ace.list.subMenu.filtering"), msgs("example.ace.list.filtering.description"),
								 "list", "listFiltering.xhtml", "ListFilteringBean.java")),
				...
				new ComponentGroup("ace:listExporter", "ListExporter", "listExporter.html",
				...
				new ComponentGroup("ace:schedule", "Schedule", "schedule.html",
						...
						new Demo(msgs("menu.ace.schedule.subMenu.styling"), msgs("example.ace.schedule.styling.description"),
							new DemoSource[] { 
								...
								new DemoSource(DemoSource.Type.JAVA, "DefaultDistributionEventGenerator.java", "schedule") })),
				new ComponentGroup("ace:scheduleExporter", "ScheduleExporter", "scheduleExporter.html",
